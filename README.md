## Rest Assured- OMDB API Test

*Bu Proje OMDb API'sini test eden bir projedir.http://www.omdbapi.com/ end point'ine **_apiKey ve s_** parametreleriyle gidip **_Harry Potter_** isimli filtrelediğim filmleri çekiyorum.
